...
<div {{ $attributes->merge(['class' => 'flex flex-col gap-4 rounded-2xl border border-zinc-100 bg-white p-4 transition-all hover:border-brand-100 hover:shadow-lg sm:flex-row sm:items-center sm:gap-6 sm:p-5 dark:border-zinc-800 dark:bg-zinc-900']) }}>
    <div class="flex min-w-0 items-center gap-4 sm:contents">
        {{-- Date box --}}
    ...
    {{-- Action --}}
    <div class="flex shrink-0 items-center justify-between gap-3 sm:flex-col sm:items-end sm:gap-2">
        @if ($quota)
