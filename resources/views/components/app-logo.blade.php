...
<a href="/" wire:navigate {{ $attributes->merge(['class' => 'flex items-center gap-3']) }}>
    ...
    <span class="flex flex-col leading-none">
        <span class="text-base font-bold tracking-tight text-zinc-900 dark:text-white {{ $titleClass }}">SIPAHAM</span>
        <span class="text-[10px] font-medium text-zinc-500 dark:text-zinc-400 {{ $subClass }}">
            RS Adam Malik
        </span>
    </span>
</a>
